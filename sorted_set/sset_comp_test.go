...
func TestCompDestroySet(t *testing.T) {
	...
	var shouldHaveKeys = make([]SetKey, len(destroyKeys))
...
func TestCompRangeForwBeg(t *testing.T) {
	...
	s.RangeLimit(IntKey(eltOffset*10), InfKey(1), fn)
}
...
func TestCompRangeForwEnd(t *testing.T) {
	...
	s.RangeLimit(InfKey(-1), IntKey((numKeys-eltOffset)*10), fn)
}
...
func TestCompRangeForwBoth(t *testing.T) {
	...
	s.RangeLimit(IntKey(startElt*10), IntKey((numKeys-eltOffset)*10), fn)
	//s.RangeLimit(IntKey(130), IntKey(10110), fn)
}
...
func TestCompRangeRevAll(t *testing.T) {
	...
	s.RangeLimit(InfKey(1), InfKey(-1), fn)
}
...
func TestCompRangeRevBeg(t *testing.T) {
	...
	s.RangeLimit(IntKey((numKeys-eltOffset)*10), InfKey(-1), fn)
}
...
func TestCompRangeRevEnd(t *testing.T) {
	...
	s.RangeLimit(InfKey(1), IntKey(eltOffset*10), fn)
}
